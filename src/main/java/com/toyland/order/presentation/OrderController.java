...
public class OrderController {
    ...
    @PostMapping
    public ResponseEntity<CustomApiResponse<OrderResponseDto>> createOrder(
        @Valid @RequestBody CreateOrderRequestDto request,
        @CurrentLoginUserId Long loginUserId) {
        OrderResponseDto order = OrderResponseDto.from(
    ...
    public ResponseEntity<CustomApiResponse<OrderResponseDto>> updateOrderByOrderId(
    ...
    @PreAuthorize("hasAnyRole('CUSTOMER','MASTER', 'MANAGER', 'OWNER')")
    @GetMapping("/{orderId}")
    public ResponseEntity<CustomApiResponse<OrderResponseDto>> findOrderByOrderId(
        @PathVariable UUID orderId,
        @CurrentLoginUserId Long loginUserId) {
        return ResponseEntity
    ...
    @GetMapping("/search")
    @PreAuthorize("hasAnyRole('CUSTOMER','MASTER', 'MANAGER', 'OWNER')")
    public ResponseEntity<CustomApiResponse<Page<OrderSearchResponseDto>>> searchOrder(
